...
class BackyardFlyer(Drone):
    ...
    def __init__(self, connection):
        ...
        self.locations = [[10.0, 0.0,3.0], [10.0, 10.0, 3.0], [0.0, 10.0, 3.0], [0.0, 0.0, 3.0]]
    ...
    def local_position_callback(self):
        if self.flight_phase == Phases.TAKEOFF:
            ...
            if altitude > 0.95 * self.target_position[2]:
                self.next_location()
                #print('DEBUG: returned from next_location func',Phases.WAYPOINT)
        elif self.flight_phase == Phases.WAYPOINT:
            #print('DEBUG: moving to next location',np.linalg.norm(self.target_position[0:2] - self.local_position[0:2]))
    ...
    def next_location(self):
        ...
        self.target_position = self.locations.pop(0)
